                                        ...
                                        <div class="row">
                                            ...
                                            if ($result->num_rows > 0) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    // Get the gallery ID and encode it for URL use
                                            ...
                                            echo '<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                                <div class="innerPage_gallery-item mb-30">
                                                    ...
                                                    <a href="gallery-view.php?cid=' . $category_id . '" >
                                                   <img src="admin/gallery/' . htmlspecialchars($row['image']) . '" alt="gallery-img">
                                                    </a>
                                                       
                                                    </div>
                                                    
                                                    <div class="innerPage_gallery-content">
                                                        <a href="admin/gallery/' .$row['image'] . '" class="popup-image"><i class="fa-thin fa-plus"></i></a>
                                                    </div>
                                                </div>
                                                <div class="text-center mt-5">
                                                <h4>
                                                     <a href="gallery-view.php?cid=' . $category_id  . '">' . $row['category_name']. '</a></h4>
                                                     </div>
                                            </div>';
