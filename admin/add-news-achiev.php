...
if (isset($_POST['submit'])) {
    ...
    if ((!in_array($file_type, $allowed_types) && !$is_svg)) {
        ...
        if ($file_size < 2 * 1024 * 1024 && $icon_size < 2 * 1024 * 1024) {
            ...
            $query = "insert into news (title, description, image, news_date, status) values('$title','$description','$unique_filename','$news_date','$status')";
            mysqli_query($db, $query);
            
            $msg = "
            <div class='alert alert-success alert-dismissible fade show' role='alert' style='font-size:16px;' id='goldmessage'>
            <strong><i class='feather icon-check'></i>Thanks!</strong> News & Achievements Added Successfully.
            <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
              <span aria-hidden='true'>&times;</span>
            </button>
          </div>
...
<head>
    <title> Add News & Achievements </title>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10"> Add News & Achievements
                                </h5>
                            </div>
<!--                             <ul class="breadcrumb"> -->
                                ...
                                <div class=" ">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group"> News & Achievements Title <span class="red-text">*</span>
                                                <label class="sr-only control-label" for="name">News & Achievements Title<span
                                                        class=" ">
                                                    </span></label>
                                                	<input id="title" name="title" type="text"
                                                    placeholder=" Enter the News & Achievements Title" class="form-control input-md"
                                                    required
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group"> News & Achievements Date <span class="red-text">*</span>
                                                <label class="sr-only control-label" for="name">News & Achievements Date<span
                                                        class=" ">
                                                    </span></label>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-4 col-sm-12 col-12">
                                         ...
                                         <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">News & Achievements Description <span class="red-text">*</span>
                                                <label class="sr-only control-label" for="name">News & Achievements Description<span class=" ">
                                                    </span></label>
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <button type="submit" class="btn btn-secondary" name="submit" id="submit">
                                                <i class="feather icon-save"></i>&nbsp; Add News & Achievements
                                            </button>
                                        </div>
                                    </div>
                                </div>
