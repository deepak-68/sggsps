...
if (isset($_POST['submit'])) {
    ...
    if ((!in_array($file_type, $allowed_types) && !$is_svg) || (!in_array($icon_type, $allowed_types) && !$is_svg)) {
        ...
        if ($file_size < 2 * 1024 * 1024 && $icon_size < 2 * 1024 * 1024) {
            ...
            $query = "insert into services (title, description, image, icon, status) values('$title','$description','$unique_filename','$unique_iconname','$status')";
...
<!--                             </ul> -->
                            ...
                            <form class="contact-us" method="post" action="" enctype="multipart/form-data"
                                ...
                                <div class=" ">
                                    ...
                                    <div class="row">
    									...
    									<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
        									<div class="form-group"> Service Icon <span class="red-text">*</span>
            									<label class="sr-only control-label" for="name">Service Icon<span class=" "></span></label>
            										<div class="input-group">
                										<input name="uploaded_icon" type="file" class="form-control input-md mr-2" required accept="image/*" onchange="showIconPreviewButton()">
                										<div class="input-group-append">
	...
	<script>
        ...
        function showIconPreviewButton() {
            var previewIconBtn = document.getElementById('previewIconBtn');
            previewIconBtn.style.display = 'block';
        }

        // Function to show the icon preview modal
