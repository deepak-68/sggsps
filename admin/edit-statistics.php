                                      ...
                                      <div class="row">
                                           <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                              <div class="form-group">
                                                 <label for="achievements" class="form-label">Award Winnings</label>
                    						     <input type="text" name="achievements" class="form-control" value="<?php echo $Achievements; ?>" placeholder="Enter the number of awards win">
                                              </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                              <div class="form-group">
                                                 <label for="performance" class="form-label">Team Members</label>
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                              <div class="form-group">
                                                 <label for="projects" class="form-label">Number of Products</label>
                    						     <input type="text" name="projects" class="form-control" value="<?php echo $Projects; ?>" placeholder="Enter number of products">
                                              </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                              <div class="form-group">
