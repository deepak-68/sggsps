...
if (isset($_POST['submit'])) {
    ...
    $spotlight_date= date('Y-m-d');
    
    $sql = "INSERT INTO spotlight (title,status,description,spotlight_date) VALUES ('$title','$status','$content','$spotlight_date')";
    if ($db->query($sql) === TRUE) {
        $msg = "
            <div class='alert alert-success alert-dismissible fade show' role='alert' style='font-size:16px;' id='goldmessage'>
            <strong><i class='feather icon-check'></i>Thanks!</strong> Spotlight added successfully
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Add New Spotlight
                                </h5>
                            </div>
<!--                             <ul class="breadcrumb"> -->
                            ...
                            <form class="contact-us" method="post" action="" enctype="multipart/form-data"
                                ...
                                <div class=" ">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                               <label for="title" class="form-label">Date <span class="red-text">*</span></label>
                                               <input type="date" id="title" name="spotlight_date" class="form-control"  placeholder="Enter page title" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <button type="submit" class="btn btn-secondary" name="submit" id="submit">
                                                <i class="feather icon-save"></i>&nbsp; Add spotlight
                                            </button>
                                        </div>
                                    </div>
                                </div>
