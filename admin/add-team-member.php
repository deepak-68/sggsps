...
if (isset($_POST['submit'])) {
    ...
    if (!in_array($file_type, $allowed_types)) {
        ...
        if ($file_size < 2 * 1024 * 1024) {
            ...
            $query = "insert into team (name,designation,description,image,instagram_url,facebook_url,twitter_url,linkedin_url,status	
            ) values('$act','$designation','$description','$unique_filename','$instagram','$facebook','$twitter','$linkedin','$status')";
            mysqli_query($db, $query);

            $msg = "
            <div class='alert alert-success alert-dismissible fade show' role='alert' style='font-size:16px;' id='goldmessage'>
            <strong><i class='feather icon-check'></i>Thanks!</strong> Add Team Member Successfully
            <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
              <span aria-hidden='true'>&times;</span>
            </button>
          </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Add Team Member
                                </h5>
                            </div>
<!--                             <ul class="breadcrumb"> -->
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group"> Name <span class="red-text">*</span>
                                                ...
                                                <input id="category" name="category" type="text"
                                                    placeholder=" Enter the Name" class="form-control input-md" required
                                       ...
                                       <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="form-group"> Description
                                                <label class="sr-only control-label" for="name">Description<span class=" ">
                                                    </span></label>
                                                <textarea class="form-control" rows="5" cols="45" name="editor1"
                                                   placeholder="Enter the Description" id="editor1"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <button type="submit" class="btn btn-secondary" name="submit" id="submit">
                                                <i class="feather icon-save"></i>&nbsp; Add Team Member
                                            </button>
                                        </div>
                                    </div>
                                </div>
