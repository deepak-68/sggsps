...
$query = "SELECT * FROM notice_board WHERE notice_id = $event_id";
$result = mysqli_query($db, $query);
$event = mysqli_fetch_assoc($result);
$existingDate = $event['notice_date'];
...
if (isset($_POST['submit'])) {
    ...
    $status = $_POST['status'];
    $existingDate = $_POST['notice_date'];
        ...
        <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
          <span aria-hidden='true'>&times;</span>
            ...
            if ($file_size < 2 * 1024 * 1024) {
                ...
                $query = "UPDATE notice_board SET image = '$unique_filename' WHERE notice_id = $event_id";
    ...
    $query = "UPDATE notice_board SET title = '$title', notice_date='$existingDate', description = '$description', status = '$status' WHERE notice_id = $event_id";
    mysqli_query($db, $query);
    
    // Redirect to some page after updating event
    $status_code = base64_encode(1);
    echo ("<script>window.location.href='manage-notice-board.php?status=$status_code';</script>");
}
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Update Notice Board
                                </h5>
                            </div>
                            <ul class="breadcrumb">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label for="title" class="form-label">Notice Title <span class="red-text">*</span></label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="notice_date" id="date" class="form-control" value="<?php echo $existingDate; ?>" required>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
    										<div class="form-group">
        										<label for="name" class="form-label">Image(734px400px) <span class="red-text">*</span></label>
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label for="details" class="form-label"> Description <span class="red-text">*</span></label>
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <button type="submit" class="btn btn-secondary" name="submit"
                                                id="submit">
                                                <i class="feather icon-save"></i>&nbsp; Update Notice Board
                                            </button>
                                        </div>
                                    </div>
                                </div>
