            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="deleteForm" action="delete-contact-us.php" method="post">
...
<strong><i class='feather icon-check'></i>Success!</strong> Contact has been Updated Successfully.
