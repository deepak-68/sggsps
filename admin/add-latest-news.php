...
if (isset($_POST['submit'])) {
    ...
    if ($file_error !== UPLOAD_ERR_OK) {
        $msg = "<div class='alert alert-danger alert-dismissible fade show' role='alert' style='font-size:16px;' id='goldmessage'>
            <strong>Error!</strong> File upload error. Code: $file_error
        ...
        $msg = "<div class='alert alert-danger alert-dismissible fade show' role='alert' style='font-size:16px;' id='goldmessage'>
            <strong>Error!</strong> Invalid file type. Please upload a valid image.
            <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
                <span aria-hidden='true'>&times;</span>
            </button>
        </div>";
        ...
        $msg = "<div class='alert alert-danger alert-dismissible fade show' role='alert' style='font-size:16px;' id='goldmessage'>
            <strong>Error!</strong> File size exceeds the limit of 2MB.
            <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
                <span aria-hidden='true'>&times;</span>
            </button>
        </div>";
        ...
        if (!is_dir($upload_directory) || !is_writable($upload_directory)) {
            $msg = "<div class='alert alert-danger alert-dismissible fade show' role='alert' style='font-size:16px;' id='goldmessage'>
                <strong>Error!</strong> Upload directory does not exist or is not writable.
                <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
                    <span aria-hidden='true'>&times;</span>
                </button>
            </div>";
            ...
            if (move_uploaded_file($temp_name, $upload_directory . $unique_filename)) {
                $query = "INSERT INTO latest_news (title, description, image, news_date, status) 
                          VALUES ('$title', '$description', '$unique_filename', '$event_date', '$status')";

                if (mysqli_query($db, $query)) {
                    $msg = "<div class='alert alert-success alert-dismissible fade show' role='alert' style='font-size:16px;' id='goldmessage'>
                        <strong>Success!</strong> Latest News Added Successfully.
                        <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
                            <span aria-hidden='true'>&times;</span>
                        </button>
                    </div>";
                    ...
                    $msg = "<div class='alert alert-danger alert-dismissible fade show' role='alert' style='font-size:16px;' id='goldmessage'>
                        <strong>Error!</strong> Could not insert data into the database: " . mysqli_error($db) . "
                        <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
                            <span aria-hidden='true'>&times;</span>
                        </button>
                    </div>";
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10"> Add  Latest News
                                </h5>
                            </div>
<!--                             <ul class="breadcrumb"> -->
                                ...
                                <div class=" ">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group"> Latest News Title <span class="red-text">*</span>
                                                <label class="sr-only control-label" for="name">Latest News Title<span
                                                        class=" ">
                                                    </span></label>
                                                	<input id="title" name="title" type="text"
                                                    placeholder=" Enter the Latest News Title" class="form-control input-md"
                                                    required
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group"> Latest News Date <span class="red-text">*</span>
                                                <label class="sr-only control-label" for="name">Latest News Date<span
                                                        class=" ">
                                                    </span></label>
                                                	<input id="date" name="news_date" type="date"
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <button type="submit" class="btn btn-secondary" name="submit" id="submit">
                                                <i class="feather icon-save"></i>&nbsp; Add Latest News
                                            </button>
                                        </div>
                                    </div>
                                </div>
