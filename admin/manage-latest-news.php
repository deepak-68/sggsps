                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">All Latest News
                                </h5>
                            </div>
<!-- 							<ul class="breadcrumb"> -->
...
<!--                             </ul> -->
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                          <form id="deleteForm" action="delete-latest-news.php" method="post">
  ...
  <strong><i class='feather icon-check'></i>Success!</strong> Event has been Updated Successfully.
 ...
 */
                                        ...
                                        echo "<td>
                                            <a href='edit-latest-news.php?id=$encoded_id' class='btn btn-warning'>
                                                <i class='feather icon-edit'></i> Edit
                                            </a>
                                            <a href='delete-latest-news.php?id=$encoded_id' class='btn btn-danger' onclick='return confirm(\"Are you sure you want to delete this News?\")'>
