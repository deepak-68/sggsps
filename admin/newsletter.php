                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Newsletter Subscription
                                </h5>
                            </div>
                            <!--                             <ul class="breadcrumb"> -->
...
<strong><i class='feather icon-check'></i>Success!</strong> Subscription has been Updated Successfully.
...
<strong>Error!</strong> Subscription has been not Updated
<button type='button' class='close' data-dismiss='alert' aria-label='Close'>
<span aria-hidden='true'>&times;</span>
</button>
</div> ";
