                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
    										<div class="form-group">
        										...
        										<small class="text-muted">Leave it blank if you don't want to change the video.</small>
    										</div>
										</div>
										...
										<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
    										<div class="form-group">
        										...
        										<div class="input-group">
            										<input type="text" id="urlInput" name="url" class="form-control input-md mr-2" placeholder="Enter Video URL" value="<?php echo $row['video_url']; ?>" onchange="showUrlPreviewButton()">
        										...
        										<small class="text-muted">Leave it blank if you don't want to change the url.</small>
    										</div>
										</div>
