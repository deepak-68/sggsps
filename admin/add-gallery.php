...
if (isset($_POST['submit'])) {
    $title = $_POST['title'];
    $selected_categories = $_POST['gallery_category']; // Use null coalescing to handle undefined cases
    $status = $_POST['status'];
    ...
    if (!in_array($file_type, $allowed_types)) {
        ...
        if ($file_size < 2 * 1024 * 1024) {
            ...
            // Insert post into 'gallery' table
            $query = "INSERT INTO gallery (title, status, image, description) VALUES ('$title', '$status', '$unique_filename', '$content')";
            mysqli_query($db, $query);

            // Get the inserted post ID
            $post_id = mysqli_insert_id($db);

            // Insert categories into 'post_gallery' table
            if (is_array($selected_categories) && !empty($selected_categories)) {
                foreach ($selected_categories as $category_id) {
                    $category_id = mysqli_real_escape_string($db, $category_id); 
                    $category_query = "INSERT INTO post_gallery (gallery_id, category_id) VALUES ('$post_id', '$category_id')";
                    if (!mysqli_query($db, $category_query)) {
                        $msg = "<div class='alert alert-danger alert-dismissible fade show' role='alert' style='font-size:16px;' id='goldmessage'>
                            <strong><i class='feather icon-check'></i>Error !</strong> Unable to insert category: " . mysqli_error($db) . ".
                            <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
                              <span aria-hidden='true'>&times;</span>
                            </button>
                          </div>";
                ...
                $msg = "<div class='alert alert-danger alert-dismissible fade show' role='alert' style='font-size:16px;' id='goldmessage'>
                    <strong><i class='feather icon-check'></i>Error !</strong> No categories selected.
                    <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
                      <span aria-hidden='true'>&times;</span>
                    </button>
                  </div>";
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Add New Gallery
                                </h5>
                            </div>
<!--                             <ul class="breadcrumb"> -->
                            ...
                            <form class="contact-us" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" autocomplete="off">
                                <div class=" ">
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
    										<div class="form-group">
        										<label for="parent_category_name" class="form-label">Gallery Category <span class="red-text">*</span></label>
        											<?php
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">Description <span class="red-text">*</span>
                                                <label class="sr-only control-label" for="content">Description<span class=" ">
                                                    </span></label>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
    										<div class="form-group">Image(270px270px) <span class="red-text">*</span>
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <button type="submit" class="btn btn-secondary" name="submit" id="submit">
                                                <i class="feather icon-save"></i>&nbsp; Add Gallery
                                            </button>
                                        </div>
                                    </div>
                                </div>
