...
if(isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM gallery_category WHERE category_id = $categoryId";
    ...
    if(mysqli_num_rows($result) > 0) {
        ...
        if(isset($_POST['submit'])) {
            ...
            $updateQuery = "UPDATE gallery_category SET category_name = '$updatedCategoryName',status='$updatedCategoryStatus' WHERE category_id = $categoryId";
            if ($db->query($updateQuery) === TRUE)
            {
                ...
                echo ("<SCRIPT LANGUAGE='JavaScript'>window.location.href='manage-gallery-category.php?status=$re';</SCRIPT>");
            } 
            else 
            {
                $staus = 1;
