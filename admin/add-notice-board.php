...
if (isset($_POST['submit'])) {
    ...
    if ((!in_array($file_type, $allowed_types) && !$is_svg)) {
        ...
        if ($file_size < 2 * 1024 * 1024 && $icon_size < 2 * 1024 * 1024) {
            ...
            $query = "insert into notice_board (title, description, image, notice_date, status) values('$title','$description','$unique_filename','$event_date','$status')";
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10"> Add Notice Board
                                </h5>
                            </div>
<!--                             <ul class="breadcrumb"> -->
                                ...
                                <div class=" ">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group"> Notice Board Title <span class="red-text">*</span>
                                                <label class="sr-only control-label" for="name">Notice Title<span
                                                        class=" ">
                                                    </span></label>
                                                	<input id="title" name="title" type="text"
                                                    placeholder=" Enter the Notice Title" class="form-control input-md"
                                                    required
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group"> Notice Date <span class="red-text">*</span>
                                                <label class="sr-only control-label" for="name">Notice Date<span
                                                        class=" ">
                                                    </span></label>
                                                	<input id="date" name="notice_date" type="date"
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <button type="submit" class="btn btn-secondary" name="submit" id="submit">
                                                <i class="feather icon-save"></i>&nbsp; Add Notice
                                            </button>
                                        </div>
                                    </div>
                                </div>
