...
<!--                             </ul> -->
  ...
  <strong><i class='feather icon-check'></i>Success!</strong> Post details has been Updated Successfully.
  ...
  <strong>Error!</strong> Post details not Updated
  <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
    <span aria-hidden='true'>&times;</span>
  </button>
</div> ";
...
//                                  echo "<td>" . $truncatedContent . "</td>";
            ...
            <a href='delete-post.php?id=$encoded_id' class='btn btn-danger' onclick='return confirm(\"Are you sure you want to delete this Postt?\")'>
