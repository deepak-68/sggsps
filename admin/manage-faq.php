...
<!--                             </ul> -->
                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                          ...
                          <form id="deleteForm" action="delete-faq.php" method="post">
  ...
  <strong><i class='feather icon-check'></i>Success!</strong> FAQ has been Updated Successfully.
  ...
  <strong>Error!</strong> FAQ has been not Updated
  <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
    <span aria-hidden='true'>&times;</span>
  </button>
</div> ";
                                ...
                                while ($row = mysqli_fetch_row($result)) {
                                    ...
                                    echo "<td><input type='checkbox' name='faq_ids[]' value='$encoded_id'></td>";
                                    ...
                                    echo "<td>
                                        <a href='edit-faq.php?id=$encoded_id' class='btn btn-warning'>
                                            <i class='feather icon-edit'></i> Edit
                                        </a>
                                        <a href='delete-faq.php?id=$encoded_id' class='btn btn-danger' onclick='return confirm(\"Are you sure you want to delete this FAQ's?\")'>
    ...
    <script>
        ...
        document.getElementById("deleteSelected").addEventListener("click", function() {
            ...
            if (checkboxes.length === 0) {
                ...
                if (confirm("Are you sure you want to delete the selected FAQ's?")) {
                    form.submit();
                }
            }
        });
