...
<!--                             </ul> -->
            ...
            <div class="card">
                    ...
                    <form id="deleteForm" action="delete-gallery-category.php" method="post">
  ...
  <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
    <span aria-hidden='true'>&times;</span>
                            ...
                            while ($row = mysqli_fetch_row($result)) {
                                ...
                                echo "<td>" . $row[1] . "</td>";
                                // echo "<td>" . $row[2] . "</td>";
                                echo "<td>" . ($row[2] == 1 ? "Enable" : "Disable") . "</td>";
                                echo "<td>
                                        <a href='edit-gallery-category.php?id=$encoded_id' class='btn btn-warning'>
                                            <i class='feather icon-edit'></i> Edit
                                        </a>
                                        <a href='delete-gallery-category.php?id=$encoded_id' class='btn btn-danger' onclick='return confirm(\"Are you sure you want to delete this category?\")'>
