...
if (isset($_POST['submit'])) {
    ...
    // Add SVG to the allowed types array if the uploaded file is SVG
    if ($is_svg) {
    ...
    // Check if the uploaded file types are allowed
    if ((!in_array($file_type, $allowed_types) && !$is_svg)) {
        ...
        if ($file_size < 2 * 1024 * 1024 && $icon_size < 2 * 1024 * 1024) {
            ...
            $query = "insert into events (title, description, image, event_date, status,time) values('$title','$description','$unique_filename','$event_date','$status','$time')";
            mysqli_query($db, $query);
            
            $msg = "
            <div class='alert alert-success alert-dismissible fade show' role='alert' style='font-size:16px;' id='goldmessage'>
            <strong><i class='feather icon-check'></i>Thanks!</strong> event Added Successfully.
            <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
              <span aria-hidden='true'>&times;</span>
            </button>
          </div>
                                ...
                                <div class=" ">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group"> Event Title <span class="red-text">*</span>
                                                <label class="sr-only control-label" for="name">Event Title<span
                                                        class=" ">
                                                    </span></label>
                                                	<input id="title" name="title" type="text"
                                                    placeholder=" Enter the Event Title" class="form-control input-md"
                                                    required
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group"> Event Date <span class="red-text">*</span>
                                                <label class="sr-only control-label" for="name">Event Date<span
                                                        class=" ">
                                                    </span></label>
                                                	<input id="date" name="event_date" type="date"
                                                    placeholder=" Enter the Event Title" class="form-control input-md"
                                                    required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
    										<div class="form-group">Image (734px400px) <span class="red-text">*</span>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group"> Event Time <span class="red-text">*</span>
                                                <label class="sr-only control-label" for="name">Event Time<span
                                                    ...
                                                    placeholder=" Enter the Event Time (10:00 - 2:00)" class="form-control input-md"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group"> Event Location <span class="red-text">*</span>
                                                <label class="sr-only control-label" for="name">Event Location<span
                                                	...
                                                	<input id="time" name="time" type="text"
                                                    placeholder=" Enter the Event Location" class="form-control input-md"
                                                    required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-4 col-sm-12 col-12">
                                         ...
                                         <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="form-group"> Event Description <span class="red-text">*</span>
                                                <label class="sr-only control-label" for="name">Event Description<span class=" ">
                                                    </span></label>
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <button type="submit" class="btn btn-secondary" name="submit" id="submit">
                                                <i class="feather icon-save"></i>&nbsp; Add Event
                                            </button>
                                        </div>
                                    </div>
                                </div>
