            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                          <form id="deleteForm" action="delete-event.php" method="post">
 ...
 */
                                        ...
                                        echo "<td>
                                            ...
                                            <a href='delete-event.php?id=$encoded_id' class='btn btn-danger' onclick='return confirm(\"Are you sure you want to delete this Event?\")'>
