...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM alumni WHERE alumni_id = $testimonialId";
...
if (isset($_POST['submit'])) {
    ...
    if ($_FILES["uploaded_file"]["size"] > 0) {
        ...
        if (!in_array($file_type, $allowed_types)) {
            ...
            if ($file_size < 2 * 1024 * 1024) {
                ...
                if (isset($_GET['id'])) {
                    ...
                    $updateQuery = "UPDATE alumni SET name = '$act', designation = '$designation', message = '$details', image = '$unique_filename', status = '$status' WHERE alumni_id = $testimonialId";
                } else {
                    // Insert new testimonial
                    $updateQuery = "INSERT INTO alumni (name, message, image, designation, status) VALUES ('$act','$details', '$unique_filename', '$status', '$designation')";
                }
                ...
                echo ("<SCRIPT LANGUAGE='JavaScript'>window.location.href='manage-alumni-testimonial.php?status=$re';</SCRIPT>");
        ...
        if (isset($_GET['id'])) {
            // Update existing testimonial
            $updateQuery = "UPDATE alumni SET name = '$act',designation = '$designation',  message = '$details', status = '$status' WHERE alumni_id = $testimonialId";
        } else {
            // Insert new testimonial
            $updateQuery = "INSERT INTO alumni (name,designation, message, status) VALUES ('$act', '$designation', '$details', '$status')";
        }
                            ...
                            <form class="contact-us" method="post" action=""
                                ...
                                <div class=" ">
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
    										<div class="form-group">Profile Pic(305px305px)
