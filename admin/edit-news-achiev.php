...
$query = "SELECT * FROM news WHERE news_id = $event_id";
$result = mysqli_query($db, $query);
$event = mysqli_fetch_assoc($result);
$existingDate = $event['news_date'];
...
if (isset($_POST['submit'])) {
        ...
        <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
          <span aria-hidden='true'>&times;</span>
            ...
            if ($file_size < 2 * 1024 * 1024) {
                ...
                $query = "UPDATE news SET image = '$unique_filename' WHERE news_id = $event_id";
    ...
    $query = "UPDATE news SET title = '$title', news_date='$existingDate', description = '$description', status = '$status' WHERE news_id = $event_id";
    mysqli_query($db, $query);
    
    // Redirect to some page after updating event
    $status_code = base64_encode(1);
    echo ("<script>window.location.href='manage-news-achiev.php?status=$status_code';</script>");
}
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Update Achievements
                                </h5>
                            </div>
                            <ul class="breadcrumb">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label for="title" class="form-label">Achievements Title <span class="red-text">*</span></label>
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label for="details" class="form-label">Achievements Description <span class="red-text">*</span></label>
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <button type="submit" class="btn btn-secondary" name="submit"
                                                id="submit">
                                                <i class="feather icon-save"></i>&nbsp; Update Achievements
                                            </button>
                                        </div>
                                    </div>
                                </div>
