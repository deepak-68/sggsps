...
if (isset($_GET['id'])) {
    ...
    $event_id = intval(base64_decode($_GET['id']));
    ...
    $query_event = "SELECT news_id, title, news_date, image, description FROM news WHERE news_id = ? AND status = 1";
    ...
    if ($result_notice->num_rows > 0) {
        ...
        echo "<p>News & Achievements not found or has been removed.</p>";
        exit();
    }
...
<head>
    ...
    <title>News & Achievements | Shri Guru Gobind Singh Public School</title>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-8">
                        <div class="blog_details-img border">
                            <img class="w-100 img-fluid" src="admin/services/<?php echo $image; ?>" alt="">
                        </div>
                                ...
                                <div class="blog_details-meta">
                                    <div class="blog_details-author">
                                        ...
                                        <div class="blog_details-author-info">
                                            <!-- <span>Teacher</span>
                                                <h5><a href=""><?php echo $name ?? 'Unknown Author'; ?></a></h5> -->
                                        </div>
                                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="blog_details-sidebar mb-60">
                            ...
                            <?php
                            require_once('news-achievements-sidebar.php');
