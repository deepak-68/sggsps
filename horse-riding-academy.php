...
<head>
    ...
    <title>Horse Riding | Shri Guru Gobind Singh Public School</title>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="breadcrumb-content">
                            <h2 class="breadcrumb-title">Horse Riding</h2>
                    ...
                    <div class="col-xl-5 col-lg-6">
                        <div class="section-area-2">
                            <h2 class="section-title mb-50">
                                SGGS <span>Horse Riding <img src="assets/img/banner/2/line.png" alt=""></span>
                            </h2>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="tabs-container">
                            <div class="tab active" data-target="section1">About Horse Riding</div>
