...
<head>
    ...
    <title>Crciket Academy | Shri Guru Gobind Singh Public School</title>
    ...
    <style>
        ...
        .tab:hover {
            background: linear-gradient(to right,  #192f59, #903);
        }
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="breadcrumb-content">
                            <h2 class="breadcrumb-title">Crciket Academy</h2>
                            <div class="breadcrumb-list">
                                <a href="index.php">Home</a>
                                <span>Crciket Academy</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-5 col-lg-6">
                        <div class="section-area-2">
                            <h2 class="section-title mb-50">
                                SGGS <span>Crciket Academy <img src="assets/img/banner/2/line.png" alt=""></span>
                            </h2>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="tabs-container">
                            <div class="tab active" data-target="section1">About Cricket Academy</div>
                    ...
                    <div class="col-md-8">
                        <div class="content-container">
                            <div id="section1" class="content active">
                                <h4>About SGGS Cricket Academy</h4>
                                <div class="row">
                                    <div class="col-md-4">
