...
<body>
    ...
    // Query to fetch the contact_us data (if needed)
    $query = "SELECT * FROM contact_us";  // Fetching all contact_us entries
                        ...
                        <div class="modal-body p-0">
                            <div class="row g-0">
                                <div class="col-md-6 d-none d-md-block">
                                    <?php
                                    $popup_image = "";
                                    $upload_directory = 'admin/popup/';
                                    $query = "SELECT image FROM popup LIMIT 1";
                                    $result = mysqli_query($db, $query);
                                    if (mysqli_num_rows($result) > 0) {
                                        $row = mysqli_fetch_assoc($result);
                                        $popup_image = $row['image'];
                                    }
                                    ?>
                                    <img src="<?php echo !empty($popup_image) ? $upload_directory . $popup_image : 'admin/popup/popup.jpg'; ?>"
                                        alt="Popup Image" class="img-fluid h-100 w-100" style="object-fit: cover;">
                                </div>
                                <div class="col-md-6 p-4 position-relative">
                                    <button type="button" class="btn-close custom-close-btn position-absolute top-0 end-0 m-3" data-bs-dismiss="modal" aria-label="Close"></button>
                                    ...
                                    <form method="POST" id="contact-form">
                                        ...
                                        <div class="mb-3">
                                            <input id="phone" class="form-control" type="tel" name="phone" placeholder="Phone" required>
                                        </div>
                                        ...
                                        <button type="submit" id="submit-btn" class="btn btn-custom w-100" disabled>Submit <i class="fa fa-save"></i></button>
                                    </form>
                                </div>
                            </div>
                        </div>
    ...
    <main>
        <section class="slider-area fix">
            ...
            if ($result->num_rows > 0) {
                ...
                $isActive = true; // To track the first image and set it as active
                while ($row = $result->fetch_assoc()) {
                    echo '<div class="carousel-item ' . ($isActive ? 'active' : '') . '" data-bs-interval="10000">
                    <img src="admin/image_slider/' . $row["image"] . '" class="d-block w-100" alt="sliders">
                  </div>';
                    $isActive = false; // After the first iteration, ensure no other item is active
                }
            ...
            <div class="swiper h7_slider-active-nav">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="h7_slider-thumb-item" data-background="assets/img/Academics.jpg">
                            ...
                            <div class="h7_slider-thumbs-info">
                                <h4>Academics</h4>
                                <a href="academic-program.php">Read More<i class="fa fa-arrow-up" style="transform: rotate(45deg);"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="h7_slider-thumb-item" data-background="assets/img/Sports.jpg">
                            <div class="h7_slider-thumbs-icon">
                            ...
                            <div class="h7_slider-thumbs-info">
                                <h4>Sports</h4>
                                <a href="sports-culture.php">Read More<i class="fa fa-arrow-up" style="transform: rotate(45deg);"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="h7_slider-thumb-item" data-background="assets/img/Co-curricular.jpg">
                            <div class="h7_slider-thumbs-icon">
                    ...
                    <div class="swiper-slide">
                        <div class="h7_slider-thumb-item" data-background="assets/img/Campus.jpg">
                            <div class="h7_slider-thumbs-icon">
                            ...
                            <div class="h7_slider-thumbs-info">
                                <h4>Campus</h4>
                                <a href="about-us.php">Read More<i class="fa fa-arrow-up" style="transform: rotate(45deg);"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <p class="element">
                        <marquee behavior="scroll" direction="left" onmouseover="this.stop();" onmouseout="this.start();">
                            CBSE ZONAL ARCHERY TOURNAMENT 2024 <a href="https://rungtapublicschool.ac.in/downloads/Tournament%20Details%20and%20Formats.pdf"> Click Here</a></marquee>
                    </p>
                </div>
            </div>
        </div> -->
        <div class="container-fluid pb-80">
            <div class="ticker-wrapper-h">
                <div class="heading">Admission Open 2025-2026</div>

                <ul class="news-ticker-h">
                    <li><a href="tel:+919229344486">For any Enquiry, Please Contact +91 92293 44486</a></li>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6">
                        <div class="h7_about-wrap mb-50 mr-70">
                            <div class="section-area-6 mb-55">
                                ...
                                <h2 class="section-title mb-15">Welcome to Shri Guru Gobind Singh Public School!</h2>
                                <p class="text-dark" style="text-align: justify;">We at Shri Guru Gobind Singh Public School believe that every child is a unique learner, with the teacher serving as a guide and mentor. Our educators are passionate, enthusiastic, caring, and supportive. SGGS is committed to delivering high-quality teaching and pastoral care, upholding strong discipline, fostering a solid value system, and providing state-of-the-art infrastructure along with a tech-savvy learning environment.We also offer an outstanding range of opportunities beyond the classroom, helping students grow holistically.</p>
                                <a href="about-us.php" class="theme-btn theme-btn-7">Read More<i class="fa-light fa-arrow-right"></i></a>
                            </div>
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="h7_about-img w_img mb-50">
                            <img src="assets/img/about/child.jpg" alt="">
                            <a href="https://www.youtube.com/channel/UCLFKF4aEnl0MbTG_n_waYSw" class="popup-video">
        ...
        <section class="pb-50">
            <div class="container">
                <div class="row gx-3" id="number-section">
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 mb-4 mt-4">
                        <div class=" p-relative">
                            <div class="number-item num-item-orange item-top">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 mb-4 mt-4">
                        <div class="it-gallery-item p-relative">
                            <div class="number-item num-item-green item-top">
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-6 col-sm-6">
                        <div class="h7_counter-item justify-content-xl-start justify-content-center mb-10">
                            <div class="h7_counter-info">
                                ...
                                <span class="h7_counter-info-text">Student Enrolled</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-3 col-md-6 col-sm-6">
                        <div class="h7_counter-item justify-content-center mb-10">
                            <div class="h7_counter-info">
                                <h3 class="h7_counter-info-title">
                                    <span class="odometer count_one" data-count="33">00</span>
                                    <span>k+</span>
                                </h3>
                                <span class="h7_counter-info-text">Class Completed</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-3 col-md-6 col-sm-6">
                        <div class="h7_counter-item justify-content-center mb-10">
                            <div class="h7_counter-info">
                                ...
                                <span class="h7_counter-info-text">Student Retention</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-3 col-md-6 col-sm-6">
                        <div class="h7_counter-item justify-content-xl-end justify-content-center mb-10">
                            <div class="h7_counter-info">
                                <h3 class="h7_counter-info-title">
                                    <span class="odometer count_one" data-count="354">00</span>
                                    <span>+</span>
                                </h3>
                                <span class="h7_counter-info-text">Top Instructors</span>
                            </div>
                        </div>
                    </div>
        ...
        <!-- counter area end -->
        <section class="leadership-section  pt-30 pb-80">
            <h2 class="section-title">LEADERSHIP</h2>
            <div class="leadership-container">
                <div class="leadership-card">
                    <img src="assets/img/about/paramjit.jpg" alt="Chairman">
                    <h5>Er. Parmjit Singh</h5>
                    <p>Chairman</p>
                </div>
                <div class="leadership-card">
                    <img src="assets/img/about/prabhjit.jpg" alt="Managing Director">
                    <h5>Er. Prabhjit Singh</h5>
                    <p>Managing Director</p>
                </div>
                <div class="leadership-card">
                    <img src="assets/img/about/aravinder.jpg" alt="Vice Chairman">
                    <h5>Smt. Aravindar Kaur</h5>
                    <p>Vice Chairman</p>
                </div>
                <div class="leadership-card">
                    <img src="assets/img/about/amandeep.jpg" alt="Principal">
                    <h5>Mrs. Amandeep Kaur </h5>
                    <p>Director</p>
                </div>
            </div>
        </section>
        <!-- principal message area start -->
        <section class="h7_about-area pt-70 ">
            <div class="container">
                <div class="row">
                    <div class="col-xl-4 col-lg-4">
                        <div class="h7_about-img w_img mb-50">
                            <img src="assets/img/about/prabhjit.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-xl-8 col-lg-8">
                        <div class="h7_about-wrap mb-50 mr-70">
                            <div class="section-area-6 mb-55">
                                <h2 class="section-title mb-15">From the Principal's Desk</h2>
                                <p class="text-dark" style="text-align: justify;">Our goal at Shri Guru Gobind Singh Public School is to provide a safe, comfortable learning environment that promotes an atmosphere of trust, responsibility, respect, and tolerance among all students. The learning environment at a school is one of the biggest keys to learning. I see our students walk through the front door of the school, excited to learn and free of fear and intimidation. Our wish is for all the students, here at SGGS, to have a positive educational experience. We appreciate all the support we receive from parents and community members as we strive to achieve our common goals. Educating the children is a true partnership. Your child’s learning involves and revolves around an effective partnership between home & school. We know the stronger the partnership is the more your child will benefit.</p>
                                <div class="d-flex flex-column flex-sm-row justify-content-between align-items-center">
                                    <h5 class="text-center text-sm-end mb-2 mb-sm-0"> Er. Prabhjit Singh(SGGS Principal)</h5>
                                    <a href="principal.php" class="theme-btn theme-btn-7">Read More <i class="fa-light fa-arrow-right"></i></a>
                                </div>
        ...
        <!-- principal message area end -->
        <div class="container pb-80">
            <div class="row gy-4">
                <div class="col-md-4 col-sm-12 col-lg-4">
                    <h4 class="up-coming-title">
                        <i class="fa-light fa-calendar-days"></i> &nbsp; Latest Event
                    </h4>
                    <div class="event-container">
                        <?php
                        $query = "SELECT * FROM events WHERE Status = 1 ORDER BY event_date DESC LIMIT 2;";
                        $result = $db->query($query);
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                $event_id = $row['event_id']; // Fetch Event ID
                                $title = $row['title'];
                                $eventDay = date("d", strtotime($row['event_date'])); // Get Day
                                $eventMonth = strtoupper(date("M", strtotime($row['event_date']))); // Get Month in Uppercase
                        ?>
                                <div class="event-card">
                                    <div class="event-date">
                                        <span style="font-size: 22px; font-weight: bold;"><?php echo $eventDay; ?></span>
                                        <span style="font-size: 12px;"><?php echo $eventMonth; ?></span>
                                    </div>
                                    <div class="event-details">
                                        <div class="event-title">
                                            <a href="event-details.php?id=<?php echo base64_encode($event_id); ?>">
                                                <?php echo $title; ?>
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <?php
                            ...
                            echo "<p style='text-align: center; color: red;'>No Events Found</p>";
                        }
                        ?>
                ...
                <div class="col-md-4 col-sm-12 col-lg-4">
                    <h4 class="up-coming-title">
                        <i class="fa-light fa-calendar-days"></i> &nbsp; Notice Board
                    </h4>
                    <div class="event-container">
                        <?php
                        $query = "SELECT * FROM notice_board WHERE Status = 1 ORDER BY notice_date DESC LIMIT 2;";
                        $result = $db->query($query);
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                $event_id = $row['notice_id']; // Fetch Event ID
                                $title = $row['title'];
                                $eventDay = date("d", strtotime($row['notice_date'])); // Get Day
                                $eventMonth = strtoupper(date("M", strtotime($row['notice_date']))); // Get Month in Uppercase
                        ?>
                                <div class="event-card">
                                    <div class="event-date">
                                        <span style="font-size: 22px;"><?php echo $eventDay; ?></span>
                                        <span style="font-size: 12px;"><?php echo $eventMonth; ?></span>
                                    </div>
                                    <div class="event-details">
                                        <div class="event-title">
                                            <a href="notice-board-details.php?id=<?php echo base64_encode($event_id); ?>">
                                                <?php echo $title; ?>
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <!-- View All Button -->
                        <a href="notice-board.php" class="view-all-btn">View All</a>
                    </div>
                </div>

                <div class="col-md-4 col-sm-12 col-lg-4">
                    <h4 class="up-coming-title">
                        <i class="fa fa-calendar-days"></i> &nbsp; Spotlight
                    </h4>
                    <div class="event-container">
                        <?php
                        $query = "SELECT * FROM spotlight WHERE Status = 1 ORDER BY spotlight_date DESC LIMIT 2;";
                        $result = $db->query($query);
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                $event_id = $row['spotlight_id']; // Fetch Event ID
                                $title = $row['title'];
                                $eventDay = date("d", strtotime($row['spotlight_date'])); // Get Day
                                $eventMonth = strtoupper(date("M", strtotime($row['spotlight_date']))); // Get Month in Uppercase
                        ?>
                                <div class="event-card">
                                    <div class="event-date">
                                        <span style="font-size: 22px;"><?php echo $eventDay; ?></span>
                                    ...
                                    <div class="event-details">
                                        <div class="event-title">
                                            <a href="spotlight-details.php?id=<?php echo base64_encode($event_id); ?>">
                                                <?php echo $title; ?>
                                            </a>
                                        </div>
                        ...
                        ?>
                        <!-- View All Button -->
                        <a href="spotlight.php" class="view-all-btn">View All</a>
                    </div>
        ...
        <section class="pb-80">
            <div class="features-section  text-white ">
                <div class="container">
                    <div class="row text-center">
                        <div class="col-md-2 col-sm-6 mb-4">
                            <div class="feature-item">
                                <i class="bi bi-easel fs-1"></i>
                                <h5 class="mt-3">Smart Classrooms</h5>
                            </div>
                        </div>
                        <div class="col-md-2 col-sm-6 mb-4">
                            <div class="feature-item">
                                <i class="bi bi-bus-front fs-1"></i>
                                <h5 class="mt-3">GPS Enabled Transport</h5>
                            </div>
                        </div>
                        <div class="col-md-2 col-sm-6 mb-4">
                            <div class="feature-item">
                                <i class="bi bi-bank fs-1"></i>
                                <h5 class="mt-3">Exemplary Library</h5>
                            </div>
                        </div>
                        <div class="col-md-2 col-sm-6 mb-4">
                            <div class="feature-item">
                                <i class="bi bi-tv fs-1"></i>
                                <h5 class="mt-3">State of the art Auditorium</h5>
                            </div>
                        </div>
                        <div class="col-md-2 col-sm-6 mb-4">
                            <div class="feature-item">
                                <i class="bi bi-camera-video fs-1"></i>
                                <h5 class="mt-3">CCTV Monitored Campus</h5>
                            </div>
                        </div>
                        <div class="col-md-2 col-sm-6 mb-4">
                            <div class="feature-item">
                                <i class="bi bi-award fs-1"></i>
                                <h5 class="mt-3">Contemporary Laboratories</h5>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-end mb-30">
                    ...
                    <div class="col-md-3">
                        <div class="h3_category-section-button mb-40 text-md-end">
                            <a href="events.php" class="theme-btn theme-btn-medium theme-btn-6">View All Events<i class="fa-light fa-arrow-up-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-0">
                    ...
                    <div class="col-xl-7">
                        ...
                        <div class="h5_event-wrap">
                            <?php
                            $sql = "SELECT * FROM events where status=1 order by event_date desc Limit 3";
                            $result = $db->query($sql);
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                            ...
                            ?>
                                    <div class="h5_event-item">
                                        ...
                                        <div class="h5_event-item-content">
                                            ...
                                            <h5><a href="event-details.php?id=<?php echo $encoded_id; ?>"><?php echo $event_title; ?></a></h5>
                                        </div>
                                    </div>
                            <?php
                                } //end of while loop
        ...
        <section class="pt-30 pb-60">
            <div class="container-fluid" style="background:#fff3e2; text-align:justify; padding:15px;">
                <div class="row d-flex align-items-center justify-content-center">
                    <!-- Image Column -->
                    <div class="col-lg-5 col-md-6 col-sm-12 text-center mb-4 mb-md-0">
                        <img src="assets/img/campus/sggschild.jpeg" class="img-fluid" style="max-width: 100%; height: auto;">
                    </div>
                    <!-- Text Column -->
                    <div class="col-lg-5 col-md-6 col-sm-12 mb-5">
                        <h6 class="text-dark mt-5">TECH TRENDS</h6>
                        <h4 class="text-dark">TECHNOLOGY EMBRACEMENT</h4>
                        <p class="text-dark">At SGGS, we are committed to fully embracing technology to enrich and elevate the teaching-learning experience. With the integration of advanced tools and digital methods, learning becomes more accessible, effective, and engaging.</p>
                        <p class="text-dark">Our goal is to equip students with knowledge of emerging technological trends and innovations. From cutting-edge tools and techniques to next-generation developments such as Virtual Reality (VR) and Augmented Reality (AR), we ensure our students are prepared for the future.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <!-- <section class="testimonial-area">
            <div class="container">
                <div class="section-area mb-55 section-area-top text-center">
                    ...
                    <h2 class="section-title mb-20">Our Alumni</h2>

                </div>
                <div class="row justify-content-center">
                    <?php
                    // Database connection (assuming $db is already defined)
                    $query = "SELECT * FROM alumni WHERE Status = 1";
                    $result = $db->query($query);

                    if ($result && $result->num_rows > 0) {
                        echo '<div class="testimonial-active swiper">';
                        echo '<div class="swiper-wrapper pb-80">';
                    ...
                    ?>
                            <div class="col-xl-4 col-lg-5 col-md-7 col-sm-12">
                                <div class="custom-alumni">
                                    <img src="admin/alumnis/<?php echo $image ?>" alt="<?php echo $name ?>" class="img-fluid">
                                    <h3><?php echo $name ?></h3>
        ...
        <!-- <section class="container py-5">
            <div class="row align-items-center">
                <div class="col-md-6">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec iaculis nisi eget bibendum.</p>
                    <p><i class="icon fa fa-phone"></i> <strong>Call:</strong> <span class="text-primary">+91-8725002706</span></p>
                    <div class="image-container">
                        <div class="image-wrapper">
                            <img src="assets/img/campus/sggs_campus.jpg" class="img-fluid" />
                        </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-6">
                            <div class="social-card instagram">
                                ...
                                <p class="text-white">@yourhandle</p>
                            </div>
                        </div>
                        X (Twitter) Card
                        <div class="col-6">
                            <div class="social-card x">
                                ...
                                <h5 class="text-white">X (Twitter)</h5>
                                <p class="text-white">@yourhandle</p>
                            </div>
                        </div>
                        LinkedIn Card
                        <div class="col-6">
                            <div class="social-card linkedin">
                                ...
                                <p class="text-white">Company Page</p>
                            </div>
                        </div>
                        YouTube Card
                        <div class="col-6">
                            <div class="social-card youtube">
                                ...
                                <h5 class="text-white">YouTube</h5>
        ...
        <section class="testimonial-area pt-140 pb-140">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-8 col-md-10">
                        <div class="section-area mb-55 section-area-top text-center">
                            <span class="section-subtitle">Parent's Reviews</span>
                            <h2 class="section-title mb-20">What Are Parents Saying?
                            </h2>
            ...
            <div class="testimonial-wrap">
                ...
                if ($result && $result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <div class="testimonial-item">
                            <div class="testimonial-top">
                                <div class="testimonial-admin">
                                    <div class="testimonial-admin-img">
                                        <img src="admin/testimonial/' . $image . '" alt="' . $name . '">
                                    </div>
                            ...
                            <div class="testimonial-content">
                                <p align="justify" class=" text ">' . $message . '</p>
                            </div>
                        </div>
                    </div>';
                    }
                    ...
                    echo '</div>'; // Close testimonial-active swiper
                } else {
        ...
        <!-- <div class=" pb-75 ">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-area-6 mb-30">
                            <h2 class="section-title mb-0">Excellence at SGGS</h2>
                        </div>
                    </div>
                </div>
        ...
        <!-- <div class="image-section">
            <img src="assets/img/introduction.jpg" alt="Image 1">
            <div class="image-info">
                <h2>Title of Image 1</h2>
                <p>This is the description for the first image. You can provide details here.</p>
            </div>
        </div> -->

        <!-- Image Section 2 -->
        <!-- <div class="image-section">
            <img src="assets/img/introduction.jpg" alt="Image 2">
            <div class="image-info">
                <h2>Title of Image 2</h2>
                <p>This is the description for the second image. Add more context here.</p>
            </div>
        </div> -->

        <!-- Image Section 3 -->
        <!-- <div class="image-section">
            <img src="assets/img/introduction.jpg" alt="Image 3">
            <div class="image-info">
                <h2>Title of Image 3</h2>
                <p>This is the description for the third image. Customize it as needed.</p>
            </div>
        </div> -->
        ...
        <!-- <div class="container pt-105">
            <div class="section-area-4 mb-30">
                <h2 class="section-title mb-10">Our Gallery</h2>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="gallery shadow-lg">
                        ...
                        <div class="list">
                            <div class="item active">
                                <img src="assets/img/banner/7/1.jpg">
                            </div>
                            <div class="item">
                                <img src="assets/img/banner/7/2.jpg">
                            </div>
                            <div class="item">
                                <img src="assets/img/banner/7/3.jpg">
                            </div>
                            <div class="item">
                                <img src="assets/img/banner/7/1.jpg">
                            </div>
            ...
            <div class="text-md-end">
                <a href="gallery.php" class="theme-btn theme-btn-7 mt-20">See More<i class="fa-light fa-arrow-right"></i></a>
            </div>
        </div> -->
        ...
        <div class="brand-area">
            <div class="container">
                ...
                <div class="brand-wrap pb-90">
                    <div class="brand-active swiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="brand-item">
                                    <a href="#">
                                        <img src="assets/img/brand/logo-1.jpg" alt="" class="brand-hover-img">
                                        <img src="assets/img/brand/logo-1.jpg" alt="" class="brand-main-img">
                                    </a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item">
                                    <a href="#">
                                        <img src="assets/img/brand/logo-2.jpg" alt="" class="brand-hover-img">
                                        <img src="assets/img/brand/logo-2.jpg" alt="" class="brand-main-img">
                                    </a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item">
                                    <a href="#">
                                        <img src="assets/img/brand/logo-3.jpg" alt="" class="brand-hover-img">
                                        <img src="assets/img/brand/logo-3.jpg" alt="" class="brand-main-img">
                                    </a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item">
                                    <a href="#">
                                        <img src="assets/img/brand/logo-4.jpg" alt="" class="brand-hover-img">
                                        <img src="assets/img/brand/logo-4.jpg" alt="" class="brand-main-img">
                                    </a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item">
                                    <a href="#">
                                        <img src="assets/img/brand/logo-5.jpg" alt="" class="brand-hover-img">
                                        <img src="assets/img/brand/logo-5.jpg" alt="" class="brand-main-img">
                                    </a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item">
                                    <a href="#">
                                        <img src="assets/img/brand/logo-6.jpg" alt="" class="brand-hover-img">
                                        <img src="assets/img/brand/logo-6.jpg" alt="" class="brand-main-img">
                                    </a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item">
                                    <a href="#">
                                        <img src="assets/img/brand/logo-7.jpg" alt="" class="brand-hover-img">
                                        <img src="assets/img/brand/logo-7.jpg" alt="" class="brand-main-img">
                                    </a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item">
                                    <a href="#">
                                        <img src="assets/img/brand/logo-8.jpg" alt="" class="brand-hover-img">
                                        <img src="assets/img/brand/logo-8.jpg" alt="" class="brand-main-img">
                                    </a>
                                </div>
                            </div>
                        </div>
    ...
    <footer class="h6_footer-area">
        ...
        <div class="admission_apply">
            <span>
                <a href="admission-enquiry.php">
                    <img src="assets/img/applynow.webp" alt="applynow">
                </a>
            </span>
        </div>
    </footer>
    ...
    <script>
        function addSeeMoreFunctionality(className, wordLimit = 25) {
            let paragraphs = document.querySelectorAll(`.${className}`);
            paragraphs.forEach(paragraph => {
                let words = paragraph.innerText.split(" "); // Split text into words
                if (words.length > wordLimit) {
                    let shortText = words.slice(0, wordLimit).join(" ");
                    let fullText = paragraph.innerText;
                    paragraph.innerHTML = `${shortText} <span class="see-more">See More</span>`;
                    let seeMoreSpan = paragraph.querySelector(".see-more");
                    seeMoreSpan.addEventListener("click", function toggleText() {
                        if (paragraph.innerText.includes("See More")) {
                            paragraph.innerHTML = `${fullText} <span class="see-more">See Less</span>`;
                        } else {
                            paragraph.innerHTML = `${shortText} <span class="see-more">See More</span>`;
                        }
                        // Reattach event listener to newly created span
                        paragraph.querySelector(".see-more").addEventListener("click", toggleText);
                    });
                }
            });
        }
        addSeeMoreFunctionality("text"); // Apply to all paragraphs with class "expandable-text"
    </script>
    ...
    <script>
        ...
        var options = {
            ...
            "brandSetting": {
                "brandName": "Shri Guru Gobind Singh Public School",
                "brandSubTitle": "Typically replies within a day",
                "brandImg": "assets/img/icon/favicon.ico",
    ...
    <script>
        document.getElementById("contact-form").addEventListener("submit", function(event) {
            ...
            fetch("indexform.php", {
                ...
                .then(response => response.text()) // JSON format hone par .json() use karein
                .then(data => {
                    console.log("Response from server:", data); // Console me response check karein
                    try {
                        var parsedData = JSON.parse(data); // JSON parse karne ki koshish
                        var messageBox = document.getElementById("response-message");
                        messageBox.textContent = parsedData.message;
                        messageBox.className = "message " + (parsedData.success ? "success" : "error");
                        ...
                        if (parsedData.success) {
                            ...
                            }, 5000); // ✅ 5 seconds tak success/error message dikhayega
                        }
                    } catch (error) {
