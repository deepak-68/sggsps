...
if (isset($_GET['id'])) {
    ...
    $notice_id = intval(base64_decode($_GET['id']));
    ...
    $query_notice = "SELECT notice_id, title, notice_date, image, description FROM notice_board WHERE notice_id = ? AND status = 1";
    $stmt = $db->prepare($query_notice);
...
<head>
    ...
    <title>Notice Board | Shri Guru Gobind Singh Public School</title>
                ...
                <div class="row">
                        ...
                        <div class="blog_details-wrap mb-60">
                            <div class="blog_details-top mb-50">
                                ...
                                <div class="blog_details-inner-text mr-80">
                                    <p class="mb-25" align="justify"><?php echo $description; ?></p>
                                </div>
                            </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="blog_details-sidebar mb-60">
                            ...
                            <?php
                            require_once('notice-board-sidebar.php');
