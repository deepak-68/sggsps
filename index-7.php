...
<!-- Mirrored from themephi.net/template/eduan/eduan/index-7.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 04 Nov 2024 05:09:44 GMT -->
<head>
        <meta charset="utf-8">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-6 col-8">
                        <div class="sidebar-logo">
                            <a href="index.php"><img src="assets/img/logo/logo-red-light.png" alt="logo-img"></a>
                        </div>
                    </div>
    ...
    <!-- header area end -->
            ...
            <div class="swiper h7_slider-active">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo '<div class="h7_single-banner bg-default" style="background-image: url(admin/image_slider/' . $row["image"] . '">';
                                echo '  <div class="container">';
                                echo '  <div class="row">';
                                echo '   <div class="col-xl-7 col-lg-8 col-md-11">';
                                echo ' <div class="h7_banner-content">';
                                echo '   <h1 class="h7_banner-content-title" data-animation="fadeInUp" data-delay="0.3s"> ' . $row['title'] . '</h1>';
                                echo '  <p class="h7_banner-content-text" data-animation="fadeInUp" data-delay="0.5s">' . $row['description'] . '</p>';
                                echo '  <div class="h7_banner-content-btn" data-animation="fadeInUp" data-delay="0.7s">';
                                echo '    <a href="#" class="theme-btn theme-btn-7">Apply Now<i class="fa-light fa-arrow-right"></i></a>';
                                echo '     <a href="#" class="theme-btn theme-btn-7 theme-btn-7-yellow">Learn More<i class="fa-light fa-arrow-right"></i></a>';
                                echo '   </div>';
                                echo ' </div>';
                                echo ' </div>';
                                echo ' </div>';
                    ...
                    <div class="h7_slider-navigation d-none d-md-grid">
                        <div class="h7_slider-prev"><i class="fa fa-arrow-down" style="transform: rotate(45deg);"></i>
                        </div>
                        <div class="h7_slider-next"><i class="fa fa-arrow-up" style="transform: rotate(45deg);"></i>
                        </div>
                    </div>
                </div>
        </section>
        ...
        <section class="h7_slider-thumb">
            <div class="swiper h7_slider-active-nav">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="h7_slider-thumb-item" data-background="assets/img/banner/7/thumb-1.jpg">
                            ...
                            <div class="h7_slider-thumbs-info">
                                <h4>Academics</h4>
                                <a href="academics.php">Read More<i class="fa fa-arrow-up" style="transform: rotate(45deg);"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="h7_slider-thumb-item" data-background="assets/img/banner/7/thumb-2.jpg">
                            <div class="h7_slider-thumbs-icon">
                            ...
                            <div class="h7_slider-thumbs-info">
                                <h4>Sports</h4>
                                <a href="facilities.php">Read More<i class="fa fa-arrow-up" style="transform: rotate(45deg);"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="h7_slider-thumb-item" data-background="assets/img/banner/7/thumb-3.jpg">
                            <div class="h7_slider-thumbs-icon">
                    ...
                    <div class="swiper-slide">
                        <div class="h7_slider-thumb-item" data-background="assets/img/banner/7/thumb-4.jpg">
                            <div class="h7_slider-thumbs-icon">
            ...
            <div class="row">
                <p class="element">
                    <marquee behavior="scroll" direction="left" onmouseover="this.stop();" onmouseout="this.start();">
                        CBSE ZONAL ARCHERY TOURNAMENT 2024 Click Here</marquee>
                </p>
            </div>
        </div>
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="h7_about-wrap mb-50 mr-70">
                            <div class="section-area-6 mb-55">
                                ...
                                <h2 class="section-title mb-15">Welcome to Rungta Public School!</h2>
                                <p class="text-dark" style="text-align: justify;">We at Rungta Public School believe that children are individual learners with teacher as a guide. The teachers are passionate, enthusiastic, caring and supporting. RPS ensures high quality of teaching and pastoral care, a good level of discipline, value system, best infrastructural facilities and tech savvy learning environment. With we provide an outstanding range of opportunities beyond class room.</p>
                        ...
                        <div class="row g-0">
                            <div class="col-xl-4 col-lg-4">
                                <div class="h7_program-item">
                                    ...
                                    <p>Our undergraduate programs tailored meet the unique needs of adult learners. Whether  seeking to advance in your current career,</p>
                                    <div class="h7_program-item-list">
                                        <a href="#">Major Program <i class="fa-light fa-arrow-right"></i></a>
                                        <a href="#">Minors Program <i class="fa-light fa-arrow-right"></i></a>
                                    </div>
                            ...
                            <div class="col-xl-4 col-lg-4">
                                <div class="h7_program-item h7_program-item2">
                                    <h3 class="h7_program-item-title">Graduate</h3>
                                    <p>Our undergraduate programs tailored meet the unique needs of adult learners. Whether  seeking to advance in your current career,</p>
...
<section class="h8_course-area pt-130 pb-120 ">
                <img src="assets/img/course/9/shape.png" alt="" class="h8_course-shape">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-8 col-lg-8 col-md-8">
                            <div class="section-area-8">
                                <h2 class="section-title mb-0">Our Featured Courses</h2>
                            </div>
                        </div>
                        ...
                        <div class="h8_course-wrap horizontal-accordion">
                            ...
                            <div class="h8_course-item h8_course_common expand h8_item_1">
                                <div class="h8_course-m-title">
                                    ...
                                    <span class="h8_course-m-title-vertical">Popular Courses</span>
                                ...
                                <div class="h8_course-content-3">
                                    <div class="course-accordion-wrap">
                                        <div class="accordion-body-img">
                                            <img src="assets/img/course/9/1.png" alt="">
                                            <span>$450</span>
                                        </div>
                                        <div class="accordion-body-bottom">
                                            <div class="accordion-body-content">
                                                <h4>Web Development</h4>
                                                <p>There are many variations of passages of Lorem Ips um available, but the majority have suffered alteration in some form, by injected humour, or randomised words which.</p>
                                                <p>Many variations of passages of Lorem Ipsum one available, but the majority have suffered alteration in <b>Sketch, Adobe XD</b> or <b>Figma</b>.</p>
                                                <div class="accordion-body-content-rating">
                                                    <div class="accordion_left">
                                                        <div class="accordion_left_img">
                                                            <img src="assets/img/course/9/2.png" alt="">
                                                            <span>20k</span>
                                                        </div>
                                                        <ul class="accordion_left_rating">
                            ...
                            <div class="h8_course-item h8_course_common small h8_item_2">
                                <div class="h8_course-m-title">
                                    ...
                                    <span class="h8_course-m-title-vertical">Featured Courses</span>
                                    <h6 class="h8_course-m-count h8_course-m-count-2">
                                        <svg width="24" height="14" viewBox="0 0 24 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M17 1L23 7L17 13" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path opacity="0.7" d="M9 1L15 7L9 13" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <div class="h8_course-item h8_course_common small h8_item_3">
                                <div class="h8_course-m-title">
                                    ...
                                    <span class="h8_course-m-title-vertical">Newly Added</span>
                                    <h6 class="h8_course-m-count h8_course-m-count-2">
                                        <svg width="24" height="14" viewBox="0 0 24 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M17 1L23 7L17 13" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path opacity="0.7" d="M9 1L15 7L9 13" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <div class="h8_course-item h8_course_common small h8_item_4">
                                <div class="h8_course-m-title">
                                    ...
                                    <span class="h8_course-m-title-vertical">Top Rated</span>
                                    <h6 class="h8_course-m-count h8_course-m-count-2">
                                        <svg width="24" height="14" viewBox="0 0 24 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M17 1L23 7L17 13" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path opacity="0.7" d="M9 1L15 7L9 13" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <div class="h8_course-item h8_course_common small h8_item_5">
                                <div class="h8_course-m-title">
                                    ...
                                    <span class="h8_course-m-title-vertical">Top Sell</span>
                                    <h6 class="h8_course-m-count h8_course-m-count-2">
                                        <svg width="24" height="14" viewBox="0 0 24 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M17 1L23 7L17 13" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path opacity="0.7" d="M9 1L15 7L9 13" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <!-- campus area start -->
            <section class="h6_campus-area fix pt-105">
            ...
            <section class="h7_scholarship-area fix pt-105">
                <div class="container">
        ...
        <section class="h10_testimonial-area  pb-120 fix">
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        <h1 class="h10_testimonial-title mb-35"><span><img src="assets/img/testimonial/10/shape-1.png" alt="">A</span>
                            <strong class="waviy">
    ...
    <div class="col-xl-6 col-lg-7 col-md-7">
        <div class="h10_testimonial-wrap mr-45 position-relative">
            ...
            <div class="h10_testimonial-active swiper">
                <div class="swiper-wrapper">
                    <?php
                    $query = "SELECT * FROM alumni WHERE Status = 1 LIMIT 5";
                    $result = $db->query($query);
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            $message = $row['message'];
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="h10_testimonial-admin">
                                                    <img src="admin/alumnis/<?php echo $image;?>" alt="">
                                                </div>
                                            </div>
    ...
    <div class="col-xl-5 col-lg-5 col-md-5">
        <div class="h10_testimonial-img ml-10 w_img">
            <img src="assets/img/testimonial/10/1.png" alt="" class="wow fadeInRight" data-wow-delay="0.3s">
        </div>
    </div>
</div>
        ...
        <!-- testimonial area end -->
            ...
            <!-- testimonial area start -->
            <section class="h6_testimonial-area pt-120 pb-120 bg-default pt-215 pb-100 fix" data-background="assets/img/testimonial/6/1.jpg">
...
<!-- Mirrored from themephi.net/template/eduan/eduan/index-7.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 04 Nov 2024 05:09:49 GMT -->
</html>