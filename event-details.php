...
if (isset($_GET['id'])) {
    ...
    $query_event = "SELECT event_id, title, event_date, image, description FROM events WHERE event_id = ? AND status = 1";
    ...
    if ($result_notice->num_rows > 0) {
        ...
        echo "<p>Events not found or has been removed.</p>";
        exit();
    }
...
<head>
    ...
    <title>Events | Shri Guru Gobind Singh Public School</title>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="blog_details-sidebar mb-60">
                            ...
                            <?php
                            require_once('event-sidebar.php');
