...
<html class="no-js" lang="zxx">
    <head>
        ...
        <title>Spotlights | Rungta Public School</title>
        ...
        <main>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="breadcrumb-content">
                                <h2 class="breadcrumb-title">Spotlights</h2>
            ...
            <section class="innerPage_blog-area pt-120 pb-90">
                <div class="container">
                    <div class="row">
                    <?php 
            $sql = "SELECT * FROM spotlight where status =1 ORDER BY spotlight_date LIMIT 3" ;
            $result = ($db->query($sql));
            if ($result->num_rows>0){
                while ($row=$result->fetch_assoc()){
                    $news_id = $row['spotlight_id'];
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <div class="h2_blog-item mb-30">
                                <div class="h2_blog-img">
                                    <a href="spotlight-details.php?id=<?php echo $encoded_id; ?>">
                                ...
                                <div class="h2_blog-content">
                                    ...
                                    <a href="spotlight-details.php?id=<?php echo $encoded_id; ?>" class="theme-btn blog-btn t-theme-btn">Read More</a>
                                </div>
                            </div>
                        </div>
