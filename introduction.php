...
<head>
    ...
    <title>Home | Rungta Public School</title>
...
<body>
  ...
  <div class="row">
    <!-- Sidebar -->
    <nav class="col-md-3 col-lg-3 sidebar-list">
      <ul class="nav flex-column">
      <li class="nav-item">
          <a class="nav-link active" href="about-us.php">About RPS</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="introduction.php">Introduction</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="school-board-affiliations.php">School Board & Affiliations</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="why-rungta.php">Why Rungta?</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="what-your-child-would-be.php">What Your Child Would Be?</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="general-instructions.php">General Instructions</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="rules-regulations.php">Rules & Regulations</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="discipline">Discipline Codes</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="disciplinary.php">Disciplinary Measures</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="child-care-protection-policies.php">Child CAre and Protection Policies</a>
        </li>
      </ul>
    </nav>
    <!-- Content Area -->
            ...
            <div class="container">
                <div class="h6_cta-wrapper" data-background="assets/img/cta/7/bg.jpg">
                    ...
                    <div class="h6_cta-content mb-30 mb-md-0">
                        <h2 class="h6_cta-title">Admission Open for 2024-25</h2>
                    </div>
