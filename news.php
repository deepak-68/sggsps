...
<html class="no-js" lang="zxx">
    <head>
        ...
        <title>News | Rungta Public School</title>
        ...
        <main>
            ...
            <section class="innerPage_blog-area pt-120 pb-90">
                <div class="container">
                    <div class="row">
                    <?php 
            $sql = "SELECT * FROM latest_news where status =1 ORDER BY news_date LIMIT 3" ;
            $result = ($db->query($sql));
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <div class="h2_blog-item mb-30">
                                <div class="h2_blog-img">
                                    <a href="news-details.php?id=<?php echo $encoded_id; ?>">
                                ...
                                <div class="h2_blog-content">
                                    ...
                                    <h5 class="h2_blog-content-title"><a href="news-details.php?id=<?php echo $encoded_id; ?>"><?php echo $title; ?></a></h5>
                                    <a href="news-details.php?id=<?php echo $encoded_id; ?>" class="theme-btn blog-btn t-theme-btn">Read More</a>
                                </div>
                            </div>
                        </div>
